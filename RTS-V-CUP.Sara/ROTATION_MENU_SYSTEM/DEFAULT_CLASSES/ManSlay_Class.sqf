...
_menuItems = 
	[
		...
		["Slay", RTMS_DEFAULT_SUB_COLOR, RTMS_DEFAULT_SUB_SIZE, RTMS_DEFAULT_SUB_TEXT_SIZE, "PuristaMedium", {(_this select 0) setdamage 1;}, [], _distance, [[], {(alive (_this select 0))}], "A3\ui_f\data\IGUI\Cfg\Actions\gear_ca.paa"]
	];
