...
RTS_FNC_INIT_PLAYERACTIONS = {
    ...
    _playerunit addAction ["<t color='#D80000'>" + "Base Construction Menu" + "</t>", Zen_RTS_BuildMenuStructures, [], 100, false, true, "", "((_this == player) && {(_this in WestTruck)})"];
    _playerunit addAction ["<t color='#D80000'>" + "Base Construction Menu" + "</t>", Zen_RTS_BuildMenuStructures, [], 100, false, true, "", "((_this == player) && {(_this in EastTruck)})"];
