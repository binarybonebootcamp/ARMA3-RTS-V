...
_Zen_stack_Trace = ["Zen_RTS_StrategicBuildingRemove", _this] call Zen_StackAdd;
...
if (count _indexes == 0) exitWith {
    ZEN_FMW_Code_ErrorExitVoid("Zen_RTS_StrategicBuildingRemove", "Given building type does not exist.")
};

_index = _indexes select 0;
0 = [Zen_RTS_Strategic_Building_Types, _index] call Zen_ArrayRemoveIndex;
