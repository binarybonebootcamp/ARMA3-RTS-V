...
private ["_constructor", "_destructor", "_upgrades", "_name", "_description", "_identifier", "_cost"];

if !([_this, [["STRING"], ["STRING"], ["ARRAY"], ["STRING"], ["STRING"], ["SCALAR"]], [[], [], ["STRING"]], 5] call Zen_CheckArguments) exitWith {
...
Zen_RTS_Strategic_Building_Types pushBack [_identifier, "", "", [], "", "", 0];
// publicVariable "Zen_RTS_Strategic_Building_Types";

0 = [_identifier, _constructor, _destructor, _upgrades, _name, _description, _cost] call Zen_RTS_StrategicBuildingTypeUpdate;
