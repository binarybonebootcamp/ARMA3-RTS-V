...
Zen_RTS_BuildingType_East_CJ = ["Zen_RTS_F_East_CJConstructor", "Zen_RTS_F_East_CJDestructor", [], "CJ", "Cost: 1000, Time: 10, Picture:pictures\rts_lvs.paa,"] call Zen_RTS_StrategicBuildingCreate;
